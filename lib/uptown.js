...
exports.extend = function(protoProps, staticProps, gettersSetters) {
  ...
  // Provide a super function for calling constructor and methods of parents
  child.prototype.__super = function(method) {
    ...
    // For the constructor of the parent
    return child.__parent.call(this);
  }
